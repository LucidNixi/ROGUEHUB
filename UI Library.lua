...
local library = utility.table({theme = table.clone(themes.Rogue), folder = "Rogue", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "Rogue"}
...
function library:Load(options)
	...
	local theme = options.theme and options.theme or "Rogue"
