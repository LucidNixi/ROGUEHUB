...
local UtilityFunctions = {
	...
	WrapObject = function(self, Object, PseudoName, Allowed, RenderDistance)
		...
		repeat wait(0.05) until Entry.IsAPlayer and FindFirstChildOfClass(__index(Entry.Object, "Character"), "Humanoid") or true
...
pcall(spawn, function()
	if Environment.Settings.LoadConfigOnLaunch then
		repeat wait(0.05) until Environment.LoadConfiguration
